...
namespace BTLONKY5.Controllers
{
    public class BookingController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,IDTable,IDAccount,NameBooking,sdtBooking,Date,Checkin,Checkout,IDFood")] Booking booking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,IDTable,IDAccount,NameBooking,sdtBooking,Date,Checkin,Checkout,IDFood")] Booking booking)
        {
            if (id != booking.ID)
            {
                return NotFound();
